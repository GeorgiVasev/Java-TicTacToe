...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boardPrinting(gameBoard);


        while (true) {
            Scanner scan = new Scanner(System.in);
            System.out.println("Please enter placement, by selecting a number between 1 and 9:");
            ...
            piecePlacing(gameBoard, playerPos, "player");
            ...
            piecePlacing(gameBoard, compPos, "comp");
    ...
    public static void boardPrinting(char[][] gameBoard) {
    ...
    public static void piecePlacing(char[][] gameBoard, int pos, String user) {
        char symbol = ' ';
